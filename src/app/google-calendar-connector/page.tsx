...
const CONNECTOR_JSONLD = [
  {
    ...
    "name": "Google Calendar Connector for Data Studio",
    "url": "https://vizstudio.io/google-calendar-connector",
    "applicationCategory": "BusinessApplication",
    "operatingSystem": "Web",
    "description": "A community connector that brings Google Calendar data into Data Studio (formerly Looker Studio). Add multiple calendars by calendar ID and blend events with your sales data.",
